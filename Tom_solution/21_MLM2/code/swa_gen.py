...
def main():
    ...
    if args.epochs!='none':
        ...
        ckpts = [
            osp.join(args.work_dir, f'model_gen_seed{args.seed}_fold{args.fold}_epoch{i}.pth')
            for i in epochs
        ]
    else:
        ckpts = [
    ...
    average_checkpoints(ckpts, osp.join(args.work_dir, f'model_gen_seed{args.seed}_fold{args.fold}_swa.pth'))

...
--experiment_name deberta_v3_large_pl_5th_tascj0 --rnn GRU --lr_scale 0.75 --epochs 6 --pl_epochs 3 --max_grad_norm 1 \
...
--experiment_name deberta_v2_xlarge_pl_5th_tascj0 --rnn GRU --lr_scale 0.2 --epochs 6 --pl_epochs 3 --max_grad_norm 1 \
--lr_schedule "linear anneal" --weight_decay 1e-2 --max_len 1280 --do_val \
--train_csv_path ../../input/feedback-prize-effectiveness/train.csv \
--full_text_path ../../input/feedback-prize-effectiveness/train \
--train_pl_csv_path ../../input/train_pl.csv \
...
--experiment_name deberta_xlarge_pl_5th_tascj0 --rnn GRU --lr_scale 0.2 --epochs 6 --pl_epochs 3 --max_grad_norm 1 \
--lr_schedule "linear anneal" --weight_decay 1e-2 --max_len 1280 --do_val \
--train_csv_path ../../input/feedback-prize-effectiveness/train.csv \
--full_text_path ../../input/feedback-prize-effectiveness/train \
--train_pl_csv_path ../../input/train_pl.csv \
...
--gradient_accumulation_steps 4 --batch_size 2 --nfolds {N_FOLDS} \
--experiment_name deberta_v2_xlarge_pl_5th --rnn GRU --lr_scale 0.2 --epochs 6 --pl_epochs 3 --max_grad_norm 1 \
--lr_schedule "linear anneal" --weight_decay 1e-2 --max_len 1280 --do_val \
--train_csv_path ../../input/feedback-prize-effectiveness/train.csv \
--full_text_path ../../input/feedback-prize-effectiveness/train \
--train_pl_csv_path ../../input/train_pl.csv \
...
--gradient_accumulation_steps 8 --batch_size 4 --nfolds {N_FOLDS} \
--experiment_name deberta_v3_large_pl_5th --rnn GRU --lr_scale 0.75 --epochs 6 --pl_epochs 3 --max_grad_norm 1 \
--lr_schedule "linear anneal" --weight_decay 1e-2 --max_len 1280 --do_val \
--train_csv_path ../../input/feedback-prize-effectiveness/train.csv \
--full_text_path ../../input/feedback-prize-effectiveness/train \
--train_pl_csv_path ../../input/train_pl.csv \
...
--experiment_name deberta_v3_large_pl_5th_tascj0 --cpc_level 4 --lr_scale 0.75 --epochs 3 \
...
--downloaded_model_path ../../input/deberta-v2-xlarge --model_name deberta-v2-xlarge \
--gradient_accumulation_steps 8 --batch_size 16 --nfolds {N_FOLDS} \
--experiment_name deberta_v2_xlarge_pl_5th_tascj0 --cpc_level 4 --lr_scale 0.75 --epochs 3 \
--lr_schedule "linear anneal" --loss CrossEntropyLoss --split_by anchor --weight_decay 1e-2 --max_len 1280 --do_val \
--cpc_path ../../input/cpc-scheme-dataframe.json \
--train_csv_path ../../input/train_pl.csv \
--full_text_path ../../../Feedback_Prize/input/train \
...
--gradient_accumulation_steps 8 --batch_size 16 --nfolds {N_FOLDS} \
--experiment_name deberta_xlarge_pl_5th_tascj0 --cpc_level 4 --lr_scale 0.75 --epochs 3 \
--lr_schedule "linear anneal" --loss CrossEntropyLoss --split_by anchor --weight_decay 1e-2 --max_len 1280 --do_val \
--cpc_path ../../input/cpc-scheme-dataframe.json \
--train_csv_path ../../input/train_pl.csv \
--full_text_path ../../../Feedback_Prize/input/train \
...
--downloaded_model_path ../../input/deberta-v2-xlarge --model_name deberta-v2-xlarge \
--gradient_accumulation_steps 8 --batch_size 16 --nfolds {N_FOLDS} \
--experiment_name deberta_v2_xlarge_pl_5th --cpc_level 4 --lr_scale 0.75 --epochs 3 \
--lr_schedule "linear anneal" --loss CrossEntropyLoss --split_by anchor --weight_decay 1e-2 --max_len 1280 --do_val \
--cpc_path ../../input/cpc-scheme-dataframe.json \
--train_csv_path ../../input/train_pl.csv \
--full_text_path ../../../Feedback_Prize/input/train \
...
--downloaded_model_path ../../input/deberta-v3-large --model_name deberta-v3-large \
--gradient_accumulation_steps 8 --batch_size 16 --nfolds {N_FOLDS} \
--experiment_name deberta_v3_large_pl_5th --cpc_level 4 --lr_scale 0.75 --epochs 3 \
--lr_schedule "linear anneal" --loss CrossEntropyLoss --split_by anchor --weight_decay 1e-2 --max_len 1280 --do_val \
--cpc_path ../../input/cpc-scheme-dataframe.json \
--train_csv_path ../../input/train_pl.csv \
--full_text_path ../../../Feedback_Prize/input/train \
